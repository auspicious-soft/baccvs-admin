...
//         <h1 className="text-2xl sm:text-3xl font-bold text-Color-White">
//           Users
//         </h1>
//         {/* Optional: Filter or date range (future-proof) */}
//         <div className="flex items-center gap-3">
//           {/* You can add dropdown or filter buttons here later */}
//         </div>
//       </header>
...
//         {/* Users Table Section */}
//         <section className="bg-[#1E0E33] rounded-2xl p-4 sm:p-6 shadow-md overflow-x-auto">
//           <UsersPage />
//         </section>
//       </main>
//     </div>
  ...
  return (
    <div className="min-h-screen  text-white font-sans">
      ...
      <div className="flex flex-col space-y-8">
        ...
        {/* Users Table Section */}
        <div className="bg-[#1E0E33] rounded-2xl p-4 sm:p-6 shadow-md overflow-x-auto">
